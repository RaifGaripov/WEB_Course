...
from .models import Podcast, Like, Listen, Category
...
def categories(request):
    categories_ = Category.objects.all().order_by('-id')
...
def index(request):
    ...
    like_podcasts = Podcast.objects.all().order_by('likes')[:5]
    listen_podcasts = Podcast.objects.all().order_by('listened')[:5]
